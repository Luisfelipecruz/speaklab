/**
 * The confusion pairs in a reading — PRD §7.4's `/θ/ → /s/ ×34`.
 *
 * **This is the screen the whole milestone is for.** A GOP of −9.4 is a number; "you
 * produced /s/ four times where English wants /θ/" is something a person can practise.
 * m0 measured that the acoustic model names the substituted phone correctly in 10 cases
 * out of 10 — including the one probe whose *threshold* missed — so the second column is
 * the more reliable half of this table, not the decorative one.
 *
 ...
 *
 * Where the model reported no clear winner the row is absent rather than guessed at. That
 * is invariant I2: no pronunciation claim from something that did not assert it.
 */
